...
namespace EmotionPlatzi.Web.Util
{
    public class EmotionHelper
    {
        ...
        private ObservableCollection<EmoEmotion> ConvertEmotions(Scores scores, EmoFace emoface)
        {
            ...
            //LO MISMO QUE FILTERPROPERTIES
            //var filterPropertiesLinq = from p in properties
